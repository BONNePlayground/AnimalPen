...
public class AnimalInteractionProvider implements DataProvider
{
    ...
    public CompletableFuture<?> generateData(CachedOutput cache)
    {
        return this.registries.thenCompose((provider) ->
        {
            ...
            // Fishes
            featureList.add(this.generateFish(cache, EntityTypes.COD, Items.COD_BUCKET));
            featureList.add(this.generateFish(cache, EntityTypes.PUFFERFISH, Items.PUFFERFISH_BUCKET));
            featureList.add(this.generateFish(cache, EntityTypes.SALMON, Items.SALMON_BUCKET));
            featureList.add(this.generateFish(cache, EntityTypes.TROPICAL_FISH, Items.TROPICAL_FISH_BUCKET));
            featureList.add(this.generateFish(cache, EntityTypes.TADPOLE, Items.TADPOLE_BUCKET));

            // Only food animals
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.CAT,
            ...
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.DOLPHIN,
                CustomIngredient.of(ItemTags.NAUTILUS_FOOD),
                false,
                SoundEvents.DOLPHIN_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.FOX,
                CustomIngredient.of(ItemTags.FOX_FOOD),
                SoundEvents.FOX_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.GLOW_SQUID,
                CustomIngredient.of(ItemTags.NAUTILUS_FOOD),
                false,
                SoundEvents.GLOW_SQUID_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.HOGLIN,
                CustomIngredient.of(ItemTags.HOGLIN_FOOD),
                SoundEvents.HOGLIN_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.LLAMA,
                CustomIngredient.of(ItemTags.LLAMA_FOOD),
                SoundEvents.LLAMA_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.OCELOT,
                CustomIngredient.of(ItemTags.OCELOT_FOOD),
                SoundEvents.OCELOT_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.PANDA,
                CustomIngredient.of(ItemTags.PANDA_FOOD),
                SoundEvents.PANDA_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.PIG,
            ...
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.RABBIT,
                CustomIngredient.of(ItemTags.RABBIT_FOOD),
                SoundEvents.RABBIT_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.SQUID,
                CustomIngredient.of(ItemTags.NAUTILUS_FOOD),
                false,
                SoundEvents.SQUID_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.STRIDER,
                CustomIngredient.of(ItemTags.STRIDER_FOOD),
                SoundEvents.STRIDER_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.TRADER_LLAMA,
                CustomIngredient.of(ItemTags.LLAMA_FOOD),
                SoundEvents.LLAMA_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.PARROT,
                CustomIngredient.of(ItemTags.PARROT_FOOD),
                SoundEvents.PARROT_AMBIENT));

            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.WOLF,
            ...
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.DONKEY, horseFood,
                SoundEvents.DONKEY_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.HORSE, horseFood,
                SoundEvents.HORSE_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.MULE, horseFood,
                SoundEvents.MULE_AMBIENT));
            featureList.add(this.generateWithFoodAndAmbient(cache, EntityTypes.SKELETON_HORSE, horseFood,
            ...
            featureList.add(this.generateAmbient(cache, EntityTypes.BAT, SoundEvents.BAT_AMBIENT));
            featureList.add(this.generateAmbient(cache, EntityTypes.POLAR_BEAR, SoundEvents.POLAR_BEAR_AMBIENT));
            featureList.add(this.generateAmbient(cache, EntityTypes.HAPPY_GHAST, SoundEvents.HAPPY_GHAST_AMBIENT));
...
// ---------------------------------------------------------------------
    ...
    private CompletableFuture<?> generateAxolotl(CachedOutput cache)
    {
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.AXOLOTL.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.AXOLOTL.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateChicken(CachedOutput cache)
    {
        ...
        interactions.add(AnimalInteractionBuilder.create("eggs").
            ...
            lootEntry(LootEntry.of(BuiltInLootTables.CHICKEN_LAY, 80, true)).
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.CHICKEN.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.CHICKEN.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateBee(CachedOutput cache)
    {
        ...
        interactions.add(AnimalInteractionBuilder.create("shearing").
            ...
            lootEntry(LootEntry.of(AnimalPenLootTables.HONEYCOMB)).
        ...
        interactions.add(AnimalInteractionBuilder.create("glass_bottle").
            ...
            lootEntry(LootEntry.of(AnimalPenLootTables.HONEY_BOTTLE)).
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.BEE.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.BEE.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateCow(CachedOutput cache)
    {
        ...
        interactions.add(AnimalInteractionBuilder.create("milk").
            ingredient(CustomIngredient.of(Items.BUCKET)).
            lootEntry(LootEntry.of(AnimalPenLootTables.MILK_BUCKET)).
            consume(new ConsumerEntry.Replace()).
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.COW.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.COW.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateMooshroom(CachedOutput cache)
    {
        ...
        interactions.add(AnimalInteractionBuilder.create("stew").
            ...
            lootEntry(LootEntry.of(AnimalPenLootTables.MUSHROOM_STEW)).
            consume(new ConsumerEntry.Replace()).
        ...
        interactions.add(AnimalInteractionBuilder.create("stew").
            ingredient(CustomIngredient.of(Items.BOWL)).
            lootEntry(LootEntry.of(AnimalPenLootTables.SUSPICIOUS_STEW)).
            consume(new ConsumerEntry.Replace()).
        ...
        interactions.add(AnimalInteractionBuilder.create("flower").
            ingredient(CustomIngredient.of(BlockItemTags.SMALL_FLOWERS.item())).
            consume(new ConsumerEntry.Replace()).
            conditions(new ConditionEntry.MobCondition("stew_effects", Operator.HAS, new BoolValue(false))).
            conditions(new ConditionEntry.MobCondition("Type", Operator.MATCH, new StringValue("brown"))).
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.MOOSHROOM.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.MOOSHROOM.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateGoat(CachedOutput cache)
    {
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.GOAT.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.GOAT.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateSheep(CachedOutput cache)
    {
        ...
        for (DyeColor value : DyeColor.values())
        {
            interactions.add(AnimalInteractionBuilder.create("shearing").
                ingredient(CustomIngredient.merge(CustomIngredient.of(Items.SHEARS),
                    CustomIngredient.of(AnimalPenTags.COMMON_SHEARS))).
                lootEntry(LootEntry.of(AnimalPenLootTables.WOOL, 320, true)).
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.SHEEP.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.SHEEP.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateTurtle(CachedOutput cache)
    {
        ...
        interactions.add(AnimalInteractionBuilder.create("eggs").
            ingredient(CustomIngredient.of(Items.BUCKET)).
            lootEntry(LootEntry.of(AnimalPenLootTables.TURTLE_EGG, 320, true)).
            cooldown(new CooldownEntry.Linear(6000, -20, 200)).
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.TURTLE.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.TURTLE.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateFish(CachedOutput cache, EntityType<?> entityType, Item resultItem)
    {
        ...
        // Food
        if (entityType != EntityTypes.TADPOLE)
        {
    ...
    private CompletableFuture<?> generateFrog(CachedOutput cache)
    {
        ...
        interactions.add(AnimalInteractionBuilder.create("froglight").
            ...
            lootEntry(LootEntry.of(AnimalPenLootTables.FROGLIGHT)).
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.FROG.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.FROG.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateAllay(CachedOutput cache)
    {
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.ALLAY.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.ALLAY.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateSniffer(CachedOutput cache)
    {
        ...
        interactions.add(AnimalInteractionBuilder.create("eggs").
            ingredient(CustomIngredient.of(Items.BUCKET)).
            lootEntry(LootEntry.of(AnimalPenLootTables.SNIFFER_EGG, 320, true)).
            cooldown(new CooldownEntry.Linear(6000, -20, 200)).
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.SNIFFER.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.SNIFFER.builtInRegistryHolder().key());
    ...
    private CompletableFuture<?> generateArmadillo(CachedOutput cache)
    {
        ...
        interactions.add(AnimalInteractionBuilder.create("brush").
            ...
            lootEntry(LootEntry.of(AnimalPenLootTables.ARMADILLO_SCUTE)).
        ...
        JsonElement json = AnimalInteractionEntry.CODEC.
            encodeStart(JsonOps.INSTANCE,
                AnimalInteractionEntry.of(EntityTypes.ARMADILLO.builtInRegistryHolder().key(), interactions)).
            getOrThrow();

        Path file = this.pathProvider.json(EntityTypes.ARMADILLO.builtInRegistryHolder().key());
