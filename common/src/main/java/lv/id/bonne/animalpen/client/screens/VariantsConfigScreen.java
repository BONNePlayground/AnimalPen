...
public class VariantsConfigScreen extends Screen
{
    ...
    private class DisplayAnimalAmountSlider extends AbstractSliderButton
    {
        ...
        {
            super(x, y, width, height, TextComponent.EMPTY, (double) (initialValue - 1) / Math.max(1, maxValue - 1));
    ...
    public static final TranslatableComponent TITLE =
        new TranslatableComponent("gui.animal_pen.variant_selection_screen.configure.title");

    public static final TranslatableComponent MINIMAL_ANIMAL_COUNT =
        new TranslatableComponent("gui.animal_pen.variant_selection_screen.configure.minimal_animal_count");

    public static final TranslatableComponent MINIMAL_ANIMAL_COUNT_TOOLTIP =
        new TranslatableComponent("gui.animal_pen.variant_selection_screen.configure.minimal_animal_count.tooltip");

    public static final TranslatableComponent PROTECTION =
        new TranslatableComponent("gui.animal_pen.variant_selection_screen.configure.enable_protection");

    public static final TranslatableComponent PROTECTION_TOOLTIP =
        new TranslatableComponent("gui.animal_pen.variant_selection_screen.configure.enable_protection.tooltip");

    public static final TranslatableComponent ENTITY_SIZE_TOOLTIP =
        new TranslatableComponent("gui.animal_pen.variant_selection_screen.configure.entity_size.tooltip");

    public static final TranslatableComponent ENTITY_SIZE_DISABLED_TOOLTIP =
        new TranslatableComponent("gui.animal_pen.variant_selection_screen.configure.entity_size.disabled");

    public static final TranslatableComponent SAVE =
        new TranslatableComponent("gui.animal_pen.variant_selection_screen.configure.save");

    public static final TranslatableComponent CANCEL =
        new TranslatableComponent("gui.animal_pen.variant_selection_screen.configure.cancel");
